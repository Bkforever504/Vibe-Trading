...
RATCHET_ARM_PCT = 25.0     # matches flip_bot PROFIT_PROTECT_ARM_PCT
RATCHET_FLOOR_PCT = 15.0   # matches flip_bot PROFIT_PROTECT_FLOOR_PCT
RATCHET_GIVEBACK_PCT = 10.0  # matches flip_bot PROFIT_PROTECT_GIVEBACK_PCT
OOS_FRACTION = 0.20
MIN_OOS_SAMPLES = 5
