...
export function Detection() {
  ...
  return (
    <div className="min-h-full p-3 sm:p-5">
      ...
      <DetectionTab scorecard={scorecard} promotion={data.discovery?.cisd_promotion_status} governance={data.research_governance} mesEvidence={data.discovery?.mes_v2_evidence_status} />
